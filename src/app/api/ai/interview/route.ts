        ...
        if (userId && adminDb) {
            try {
                ...
                await userRef.update({
                    "usage.interviewQuestions": FieldValue.increment(1),
                    "featureUsage.interviewQuestions": FieldValue.increment(1),
                    "featureUsage.lastUsed": FieldValue.serverTimestamp()
                });
                console.log(`[Interview API] Updated usage for user ${userId}`);
