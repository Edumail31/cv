...
export default function PricingPage() {
    ...
    const plans = [
        {
            ...
            features: [
                ...
                { text: "1 ATS Resume Export (Watermarked PDF)", included: true },
        ...
        },
        {
            ...
            features: [
                ...
                { text: "Interview Questions (up to 50)", included: true },
                { text: "20 Job Fit Score Checks/month", included: true },
                { text: "10 Resume Exports (PDF + DOCX)", included: true },
    ...
    const comparisonData = [
        ...
        { feature: "Interview Questions", free: "❌", pro: "Up to 20", premium: "Up to 50" },
        { feature: "Job Fit Score", free: "❌", pro: "5/month", premium: "20/month" },
        { feature: "Resume Export", free: "1 (Watermarked)", pro: "5 (PDF+DOCX)", premium: "10 (PDF+DOCX)" },
